...
$buscar=$con->prepare("
SELECT nome, anoVigente, situacao, id FROM classe where 1 ");
...
<table id="lista_curso" class="display" style="width:75%">
    ...
    <?php
        foreach($resultado as $dado){
            ...
            <td>
            <a href='?op=gera_mat_classe&idClasse=".$dado['id']."' alt='Gerar matrículas para essa turma'><i class='fa fa-graduation-cap' id='edit'></i></a>
            </td>";
            echo "</tr>";
        }
    ?>
