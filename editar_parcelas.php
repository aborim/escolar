...
if(isset($_POST['buscar'])==1){
    ...
    where   
      ...
      if($buscar->rowCount()==0){$mensagem="Nenhuma matrícula localizada";}
    }else{
...
<form method="post" action="#" enctype="multipart/form-data" id="frmAluno">
    <div class="form_comp">
    <div class="titulo">Pesquisar Aluno: Parcelas</div>
        ...
        if(!empty($resultado)){
            ...
            foreach(@$resultado as $dado){
                ...
                echo "<tr><td >"."<img src='".$dado['imagem']."' style='width: 70px'>"."</td>
                        <td style='width: 432px'><a href='menu_restrito.php?op=ver_aluno&idAluno=".$dado['idAluno']."&nome=".base64_encode($dado['nome'])."'>".$dado['nome']."</a></td>
                        <td style='width: 100px'><a href='menu_restrito.php?op=ver_aluno&idAluno=".$dado['idAluno']."&nome=".base64_encode($dado['nome'])."'>".$dado['ra']."</a></td>
                        <td style='width: 100px'><a href='menu_restrito.php?op=ver_aluno&idAluno=".$dado['idAluno']."&nome=".base64_encode($dado['nome'])."'>".$dado['rm']."</a></td>
                        
                <td ><a href='?op=add_responsaveis&idResponsavel=".$dado['idAluno']."&fun=ed'>
                    <a href='?op=parcelas&idAluno=".$dado['idAluno']."'><i class='fa fa-money' id='edit'style='width: 10'></i>Editar</a> | 
                    <a href='?op=quitar_parcelas&idAluno=".$dado['idAluno']."'><i class='fa fa-check' id='edit'style='width: 10'></i>Quitar</a>
