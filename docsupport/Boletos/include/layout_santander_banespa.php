...
include_once "../../barcode-php/barcode.php";
?>
...
</DIV></td></tr></table><br><table cellspacing=0 cellpadding=0 width=666 border=0><TBODY><TR><TD class=ct width=666><img height=1 src=/escolar/docsupport/Boletos/imagens/6.png width=665 border=0></TD></TR><TR><TD class=ct width=666><div align=right><b class=cp>Recibo 
...
</tr><tbody><tr><td colspan=5><img height=2 src=/escolar/docsupport/Boletos/imagens/2.png width=666 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct valign=top width=7 height=13><img height=13 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=298 height=13>Cedente</td><td class=ct valign=top width=7 height=13><img height=13 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=126 height=13>Agência/Código 
do Cedente</td><td class=ct valign=top width=7 height=13><img height=13 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=34 height=13>Espécie</td><td class=ct valign=top width=7 height=13><img height=13 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=53 height=13>Quantidade</td><td class=ct valign=top width=7 height=13><img height=13 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=120 height=13>Nosso 
número</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top width=298 height=12> 
...
<td class=cp valign=top width=7 height=12><img height=12 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top width=126 height=12> 
  <span class="campo">
...
</tr><tr><td valign=top width=7 height=1><img height=1 src=/escolar/docsupport/Boletos/imagens/2.png width=7 border=0></td><td valign=top width=298 height=1><img height=1 src=/escolar/docsupport/Boletos/imagens/2.png width=298 border=0></td><td valign=top width=7 height=1><img height=1 src=/escolar/docsupport/Boletos/imagens/2.png width=7 border=0></td><td valign=top width=126 height=1><img height=1 src=/escolar/docsupport/Boletos/imagens/2.png width=126 border=0></td><td valign=top width=7 height=1><img height=1 src=/escolar/docsupport/Boletos/imagens/2.png width=7 border=0></td><td valign=top width=34 height=1><img height=1 src=/escolar/docsupport/Boletos/imagens/2.png width=34 border=0></td><td valign=top width=7 height=1><img height=1 src=/escolar/docsupport/Boletos/imagens/2.png width=7 border=0></td><td valign=top width=53 height=1><img height=1 src=/escolar/docsupport/Boletos/imagens/2.png width=53 border=0></td><td valign=top width=7 height=1><img height=1 src=/escolar/docsupport/Boletos/imagens/2.png width=7 border=0></td><td valign=top width=120 height=1><img height=1 src=/escolar/docsupport/Boletos/imagens/2.png width=120 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct valign=top width=7 height=13><img height=13 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top colspan=3 height=13>Número 
do documento</td><td class=ct valign=top width=7 height=13><img height=13 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=132 height=13>CPF/CNPJ</td><td class=ct valign=top width=7 height=13><img height=13 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=134 height=13>Vencimento</td><td class=ct valign=top width=7 height=13><img height=13 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=180 height=13>Valor 
documento</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top colspan=3 height=12> 
  <span class="campo">
  <?php echo $dadosboleto["numero_documento"]?>
  </span></td>
<td class=cp valign=top width=7 height=12><img height=12 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top width=132 height=12> 
  <span class="campo">
  <?php echo $dadosboleto["cpf_cnpj"]?>
  </span></td>
<td class=cp valign=top width=7 height=12><img height=12 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top width=134 height=12> 
  <span class="campo">
...
<img height=13 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=113 height=13>Data 
do documento</td><td class=ct valign=top width=7 height=13> <img height=13 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=153 height=13>N<u>o</u> 
...
<img height=13 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=82 height=13>Data 
processamento</td><td class=ct valign=top width=7 height=13> <img height=13 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=180 height=13>Nosso 
número</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top  width=113 height=12><div align=left> 
  <span class="campo">
  <?php echo $dadosboleto["data_documento"]?>
  </span></div></td><td class=cp valign=top width=7 height=12><img height=12 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top width=153 height=12> 
    <span class="campo">
    <?php echo $dadosboleto["numero_documento"]?>
    </span></td>
  <td class=cp valign=top width=7 height=12><img height=12 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top  width=62 height=12><div align=left><span class="campo">
 ...
 </div></td><td class=cp valign=top width=7 height=12><img height=12 src=/escolar/docsupport/Boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top  width=82 height=12><div align=left> 
   <span class="campo">
...
<td valign=top width=7 height=1><img height=1 src=/escolar/docsupport/Boletos/imagens/2.png width=1 border=0></td></tr></tbody></table></td><td valign=top width=468 rowspan=5><font class=ct>Instruções 
...
<TR>
<TD class=ct width=666><?php echo @geraCodigoBarra($dadosboleto["linha_digitavel"]);?></TD>
</TR>
