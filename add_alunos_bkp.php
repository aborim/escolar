...
<tbody>
    ...
    <th><label for="ra">RA</label></th>
        <td>
            <input required class="form_campo" type="text" value="<?php if(@$resultado[0]['ra']!=""){echo $resultado[0]['ra'];}?>" id="ra" name="ra" title="RA" maxlength="15">
    ...
    <tr>
        <th><label for="cpf">CPF</label><span class="obrigatorio">obrigat&oacute;rio</span></th>
        <td>
            <input class="form_campo" type="text" value="<?php if(@$resultado[0]['cpf']!=""){echo $resultado[0]['cpf'];}?>" id="cpfAluno" name="cpfAluno" title="CPF" maxlength="11" onkeypress="return soNumeros(event)" required>
