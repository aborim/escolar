    ...
    if(@$_POST['edita']==1){
        ...
        if(empty($_FILES['imagem']['name'])){
            ...
            if ( isset( $_FILES[ 'imagem' ][ 'name' ] ) && $_FILES[ 'imagem' ][ 'error' ] == 0 ) {
                ...
                // Converte a extensï¿½o para minï¿½sculo
                $extensao = strtolower ( $extensao );
                // Somente imagens, .jpg;.jpeg;.gif;.png
                // Aqui eu enfileiro as extensï¿½es permitidas e separo por ';'
                // Isso serve apenas para eu poder pesquisar dentro desta String
                if ( strstr ( '.jpg;.jpeg;.gif;.png', $extensao ) ) {
                    // Cria um nome ï¿½nico para esta imagem
                    // Evita que duplique as imagens no servidor.
                    // Evita nomes com acentos, espaï¿½os e caracteres n&atilde;o alfanumï¿½ricos
        ...
        if(!empty($_POST['respId'])){
            //se o vinculo do responsável não existe então cria um novo, se não só atualiza
            ...
            if($busca_vinculo->rowCount()==0){
                ...
                $altera_vinculo = $con->prepare("update aluno_responsavel set idResponsavel=:idResponsavel,financeiro=:financeiro");
...
<tbody>
    ...
    <th><label for="nome">Nome</label><span class="obrigatorio"> obrigat &oacute;rio</span></th>
        <td>
            <input class="form_campo" type="text" value="<?php if(@$resultado[0]['nome']!=""){echo $resultado[0]['nome'];}?>" id="nomeAluno" name="nomeAluno" title="Nome do Aluno" maxlength="60" required>
    ...
    <td>
        <table>
            <tbody> <?php 
                    ...
                    <?php }?>
                    <tr><td><label for="cpf">CPF do Respopns&aacute;vel:</label>
    ...
    <tr>	
        ...
        <td>
            <input class="form_campo" type="text" value="<?php if(@$resultado[0]['orgaoEmissor']!=""){echo $resultado[0]['orgaoEmissor'];}?>" id="orgaoEmissor" name="orgaoEmissor" title="Orgï¿½o emissor" maxlength="6" style="text-transform:uppercase">
...
<script src="https://code.jquery.com/jquery-3.4.1.min.js" integrity="sha256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo=" crossorigin="anonymous"></script>
    ...
    $('#cpfResponsavel').blur(function() {
        ...
        <div class="btn_pos">
    <?php if($edicao!="sim"){?>
        <input type="submit" name="btn_add_aluno" class="form_buttom" value="Adicionar Aluno"></div>
